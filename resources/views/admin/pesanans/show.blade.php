...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{ route('admin.pesanans.edit', $pesanan->id) }}" class="btn btn-warning btn-sm">
            <i class="fas fa-edit mr-1"></i> Edit
        </a>
        <a href="{{ route('admin.pesanans.index') }}" class="btn btn-secondary btn-sm">
...
<div class="row">
    ...
    <div class="card-body">
                @if($pesanan->transaksi)
                    ...
                    <a href="{{ route('admin.transaksis.show', $pesanan->transaksi->id) }}" class="btn btn-primary btn-sm btn-block">
                ...
                @else
                    <div class="text-center text-muted">
                        ...
                        @if($pesanan->status_pembayaran != 'lunas')
                            <a href="{{ route('admin.transaksis.create', ['pesanan_id' => $pesanan->id]) }}" class="btn btn-success btn-sm">
