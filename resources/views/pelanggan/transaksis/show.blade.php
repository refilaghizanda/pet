...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="{{ route('pelanggan.transaksis.edit', $transaksi->id) }}" class="btn btn-warning btn-sm">
            <i class="fas fa-edit mr-1"></i> Edit
        </a>
        <a href="{{ route('pelanggan.transaksis.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control-plaintext bg-light rounded p-2">
                                ...
                                <small class="text-muted d-block mt-1">
                                    {{ $transaksi->pesanan->hewan->jenis ?? '-' }} - {{ $transaksi->pesanan->hewan->ras ?? '-' }}
                                </small>
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control-plaintext bg-light rounded p-2">
                                ...
                                {{ \Carbon\Carbon::parse($transaksi->pesanan->tanggal_layanan)->format('d/m/Y') }}
                            </div>
                        </div>
                    </div>
                </div>
